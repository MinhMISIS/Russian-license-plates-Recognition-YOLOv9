...
from localization.utils import TryExcept
from localization.utils.dataloaders import exif_transpose
from localization.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from localization.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from localization.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from localization.utils.triton import TritonRemoteModel
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from localization.models.export import export_formats
        from localization.utils.downloads import is_url
